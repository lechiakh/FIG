...
let PlayState = {
    ...
    create: function() {
        ...
        //
        this.bg = game.add.image(0, 0, 'bg_play_' + R.playerData.theme);

        this.well = new Well(29, 125, 10, 10, quadPadding, this, Publisher.rewardedVideoAd);
        ...
        let panel = game.add.image(R.BASE_GAME_WIDTH * 0.5, R.BASE_GAME_HEIGHT * 0.5, 'gui', 'panel');
        panel.anchor.set(0.5);
        group.add(panel);

        R.ui.createHomeButton(220, 376, group);
        R.ui.createRankButton(420, 376, group, false);
        R.ui.createSoundButton(220, 553, group);

        R.ui.createSmallPlayButton(420, 553, group, this.onPlayPause, this);
        ...
        panel = game.add.image(R.BASE_GAME_WIDTH * 0.5, 500, 'gui', 'panel');
        panel.anchor.set(0.5);
        group.add(panel);
        ...
        //continue group
        group = game.add.group();
        panel = game.add.image(R.BASE_GAME_WIDTH * 0.5, 660, 'gui', 'panel');
        panel.anchor.set(0.5);
        group.add(panel);
        ...
        R.ui.createTextButton(320, 570, group, this.onWatchVideoButton, this, R.strings.watch_video);
        R.ui.createTextButton(320, 720, group, this.onCancelButton, this, R.strings.cancel);
    ...
    inputOnDown: function(e) {
        ...
        if (this.selectedShape) {
            ...
            if (!game.device.desktop) {
                this.tweenDragOffset = game.add.tween(this.inputPointOffset).to({
    ...
    showPauseMenu: function() {
        ...
        game.add.tween(this.curtain).to({
            alpha: 1.0
        }, 200, Phaser.Easing.Linear.None, true);

        this.pauseGroup.y = 600;
        game.add.tween(this.pauseGroup).to({
            y: 0
        }, 400, Phaser.Easing.Back.Out, true).onComplete.add(function(pauseGroup) {
    ...
    onPlayPause: function(button) {
        ...
        game.add.tween(this.pauseGroup).to({
            y: 600
        }, 400, Phaser.Easing.Back.In, true).onComplete.add(this.onHidePauseMenu, this);
    },
    ...
    showGameoverMenu: function() {
        ...
        game.add.tween(this.gameoverGroup).to({
            y: 0
        }, 600, Phaser.Easing.Back.Out, true).onComplete.add(function(gameoverGroup) {
    ...
    showContinueMenu: function() {
        ...
        game.add.tween(this.continueGroup).to({
            y: 0
        }, 600, Phaser.Easing.Back.Out, true).onComplete.add(function(continueGroup) {
    ...
    onPlayButton: function(button) {
        ...
        game.add.tween(this.gameoverGroup).to({
            y: 800
        }, 600, Phaser.Easing.Back.In, true).onComplete.add(this.onHideGameoverMenu, this);
    },
    ...
    onCancelButton: function(button) {
        ...
        game.add.tween(this.continueGroup).to({
            y: 600
        }, 400, Phaser.Easing.Back.In, true).onComplete.add(this.onHideContinueMenuCancel, this);
    },
    ...
    onCompleteAdVideo: function() {
        ...
        game.add.tween(this.continueGroup).to({
            y: 600
        }, 400, Phaser.Easing.Back.In, true).onComplete.add(this.onHideContinueMenu, this);
    },
