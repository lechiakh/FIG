...
Shape.prototype = {
    ...
    startDrag: function() {
        ...
        this.tweenDragScale = game.add.tween(this.parent.scale).to({
            x: quadScaleDrag,
            y: quadScaleDrag
        ...
        this.tweenDragPadding = game.add.tween(this.padding).to({
            x: quadPaddingDrag
        }, 100, Phaser.Easing.Linear.None, true);
    ...
    endDrag: function() {
        ...
        this.tweenEndDragPosition = game.add.tween(this.parent).to({
            x: this.startX,
            y: this.startY
        }, 160, Phaser.Easing.Linear.None, true);
        ...
        this.tweenEndDragScale = game.add.tween(this.parent.scale).to({
            x: quadScaleMin,
            y: quadScaleMin
        }, 160, Phaser.Easing.Linear.None, true);
    ...
    beginAddingToWell: function(well, firstAddingCell) {
        ...
        let tween = game.add.tween(this.padding).to({
            x: quadPadding
        }, 100, Phaser.Easing.Linear.None, true);
        ...
        tween = game.add.tween(this.parent).to({
            x: tx,
            y: ty
        }, 100, Phaser.Easing.Linear.None, true);
    ...
    reset: function(state) {
        ...
        let tween = game.add.tween(this.parent).to({
            x: this.startX
